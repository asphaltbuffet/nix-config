# Generated by Powerlevel10k configuration wizard on 2026-01-29 at 21:04 EST.
...
() {
  ...
  function my_git_formatter() {
    ...
    # don't show git info if this is a jj repo
    if [[ -n ./(../)#(.jj)(#qN/) ]]; then
    ...
    [[ -z $VCS_STATUS_LOCAL_BRANCH && -z $VCS_STATUS_TAG ]] &&  # <-- this line
      res+="${meta}󰜘${clean}${VCS_STATUS_COMMIT[1,8]}"
  ...
  typeset -g POWERLEVEL9K_JJ_FOREGROUND=027
  typeset -g POWERLEVEL9K_JJ_VISUAL_IDENTIFIER_EXPANSION='󰠬'
